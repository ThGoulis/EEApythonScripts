...
def main():
    ...
    with conn:
        ...
        # function.Surface_water_bodies_QE1_Biological_quality_elements_status(conn, countryCode, 2016, working_directory)
        # function.Surface_water_bodies_QE2_status(conn, countryCode, 2016, working_directory)
        # function.Surface_water_bodies_QE3_status(conn, countryCode, 2016, working_directory)
        # function.Surface_water_bodies_QE3_3_status(conn, countryCode, 2016, working_directory)
